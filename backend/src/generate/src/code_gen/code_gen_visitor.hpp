...
public:
    ...
    void operator()(DAGConcurrentExecuteLambda *op);
    ...
    void operator()(DAGExchangeTcp *op);
...
private:
     ...
     */
    auto visit_common(DAGOperator *op, const std::string &operator_name)
            -> std::string;
