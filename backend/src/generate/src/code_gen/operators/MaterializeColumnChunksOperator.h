#ifndef CODE_GEN_OPERATORS_MATERIALIZECOLUMNCHUNKSOPERATOR_H
#define CODE_GEN_OPERATORS_MATERIALIZECOLUMNCHUNKSOPERATOR_H
...
#endif  // CODE_GEN_OPERATORS_MATERIALIZECOLUMNCHUNKSOPERATOR_H
