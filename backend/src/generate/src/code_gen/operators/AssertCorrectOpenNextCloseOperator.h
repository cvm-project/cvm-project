#ifndef CODE_GEN_OPERATORS_ASSERTCORRECTOPENNEXTCLOSEOPERATOR_H
#define CODE_GEN_OPERATORS_ASSERTCORRECTOPENNEXTCLOSEOPERATOR_H
...
#endif  // CODE_GEN_OPERATORS_ASSERTCORRECTOPENNEXTCLOSEOPERATOR_H
