#ifndef CODE_GEN_OPERATORS_CONCURRENTEXECUTEPROCESSOPERATOR_H
#define CODE_GEN_OPERATORS_CONCURRENTEXECUTEPROCESSOPERATOR_H
...
class ConcurrentExecuteProcessOperator {
public:
    ConcurrentExecuteProcessOperator(Upstream *const upstream,
                                     std::string inner_plan)
        : upstream_(runtime::operators::MakeConcurrentExecuteProcessOperator(
...
template <class OutputTuple, class Upstream>
ConcurrentExecuteProcessOperator<OutputTuple, Upstream>
makeConcurrentExecuteProcessOperator(Upstream *const upstream,
                                     std::string inner_plan) {
    return ConcurrentExecuteProcessOperator<OutputTuple, Upstream>(
            upstream, std::move(inner_plan));
};

#endif  // CODE_GEN_OPERATORS_CONCURRENTEXECUTEPROCESSOPERATOR_H
