...
namespace impl
{
    ...
    void call_impl(const Function &f, const std::tuple<Types...> &t,
...
void call(const Function &f, const std::tuple<Types...> &t)
{
    impl::call_impl(f, t, std::index_sequence_for<Types...>());
}
