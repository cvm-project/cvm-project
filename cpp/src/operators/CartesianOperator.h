...
public:
    ...
    CartesianOperator(Upstream1 *upstream1, Upstream2 *upstream2) : upstream1(upstream1), upstream2(upstream2) {};
...
CartesianOperator<Upstream1, Upstream2, Tuple, UpstreamTuple>
INLINE makeCartesianOperator(Upstream1 *upstream1, Upstream2 *upstream2) {
    return CartesianOperator<Upstream1, Upstream2, Tuple, UpstreamTuple>(upstream1, upstream2);
};
